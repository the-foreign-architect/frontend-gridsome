  ...
  <Layout>
    <section class="px-4 mb-12 text-lg
      ...
      <div class="md:w-2/3 xl:w-full md:px-4">
        ...
        <p class="xl:w-3/4">City guides and articles with the best contemporary architecture around the world. Written by an architect for architecture lovers.</p>
      </div>
    </section>
    ...
    <home-section>
      ...
      <template #content>
        <iframe title="Latest Map" src="https://www.google.com/maps/d/embed?mid=1T21-qW_WpDlybRLDl1ihp-KXH7w&hl=en" height="500" scrolling="no" class="w-full border-2 border-black"></iframe>
      </template>
    </home-section>
